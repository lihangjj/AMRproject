                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <c:forEach items="${allTake}" var="take">
                                <tr>
                                    <td class="text-center"><img src="upload/res/${resMap[take.tkid].photo}" class="img"
                                                                 style="width:30px;"> ${resMap[take.tkid].title}</a>
                                    </td>
                                    ...
                                    <td class="text-center">
											<span id="butDiv-${take.tkid}">
												<c:if test="${resMap[take.tkid].rflag == 1 and take.status==1}">
                                                    <button class="btn btn-primary btn-xs"
                                                            id="retBut-${take.tkid}">归还用品</button>
                                                </c:if>
											</span>
                                    </td>
                                </tr>
